...
```
前面一句话相对好理解，但是后面一句话可能会让人觉得有点难。将专业领域细分之后带来的问题是除了学科本身的脱节，也与与一般问题脱节了。这个应该是对博雅学科的理解上存在偏差。我们可能认为博雅学科不过是一堆细分学科的合集，但是根据作者的意思来看并不是这样。实际上应该是下图左边的模式。
```
...
但是如果将学科细分了，除了学科本身之间没了联系，学科与一般问题之间的联系也被斩断了。变成了上图右边那样。
